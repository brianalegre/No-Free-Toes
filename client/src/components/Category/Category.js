    ...
    <div key={serviceUser._id} id="serviceUser-card" className='py-5 flex justify-center'>
      <div href="##" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-3xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal w-96">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{serviceUser.firstName} {serviceUser.lastName}</h5>
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{serviceUser.bio}</p>
        </div>
        <Link to={`/service/` + serviceUser._id}><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-3 mb-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">View Profile</button></Link>
      </div>
    </div>
  ));
  ...
  return (
    <>
      ...
      {/* <div class="flex items-center">
            <img class="w-20 h-20 rounded-full" src={defaultImg} alt="Rounded avatar" />
      ...
      <main className="flex flex-col min-h-screen">
        ...
        {/* <div id="serviceUser-card" className='py-5 flex justify-center'>
          <div href="##" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-3xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div className="flex flex-col justify-between p-4 leading-normal">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Brian Alegre</h5>
        ...
        <div id="serviceUser-card-2" className='py-5 flex justify-center'>
          <div href="##" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-3xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="">
              <img className="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg p-2" src={defaultImg} alt="default" />
              <div className="flex justify-center">
        ...
        <div id="serviceUser-card-3" className='py-5 flex justify-center'>
          <div href="##" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-3xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="">
              <img className="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg p-2" src={defaultImg} alt="default" />
              <div className="flex justify-center">
        ...
        <div id="serviceUser-card-4" className='py-5 flex justify-center'>
          <div href="##" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-3xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="">
              <img className="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg p-2" src={defaultImg} alt="default" />
              <div className="flex justify-center">
