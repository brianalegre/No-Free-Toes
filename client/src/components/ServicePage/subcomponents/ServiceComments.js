      ...
      <div className="min-w-full h-auto bg-white">
        <div className="flex pl-3 sm:pl-4 py-4 text-black font-bold">
          ...
          <div className="pl-2 sm:pl-3 flex flex-col align-middle">
            <p className="text-md">Michael Jordan</p>
            ...
            <span className="text-xs">8/21/2022</span>
          </div>
        </div>
        <div className="px-5 pb-6">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at
            augue rhoncus eros malesuada venenatis sed eu tellus. Mauris
            suscipit augue quis viverra porta. Class aptent taciti sociosqu ad
            litora.
          </p>
        </div>
      </div>
