            ...
            <div className="flex flex-col p-5">
                <form className="">
                    ...
                    <div className="flex justify-end">
                        <button
                            type="submit"
                            className="text-white transition delay-50 ease-in-out bg-green-600 hover:bg-green-800 font-medium rounded-lg text-lg px-2 py-1 mr-2 mb-2"
                            onClick={handleFormSubmit}
                        >
                            Submit
                        </button>
                        <button
                            className="outline outline-1 outline-gray-500 rounded-lg text-lg px-2 mr-2 mb-2 delay-50 transition ease-in-out duration-150 hover:bg-red-600 hover:text-white"
                            onClick={closeModal}
                        >
                            Close
                        </button>
