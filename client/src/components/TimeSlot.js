      ...
      <div className="flex py-36 justify-center items-center align-middle">
        <div className="flex flex-col">
          ...
          <div>
            ...
            <button className="inline-flex items-center justify-center w-8 h-8 mr-2 text-white transition-colors duration-150 bg-green-700 rounded-lg focus:shadow-outline hover:bg-green-500 hover:text-gray-700">
