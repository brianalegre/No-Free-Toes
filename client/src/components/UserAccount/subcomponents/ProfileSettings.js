    ...
    <section className="mt-5 md:ml-10 md:mt-0">
      ...
      <form className="">
        ...
        <div className="relative z-0 mb-6 w-full group">
          <label htmlFor="floating_email" className="text-xs">
            Email address
          </label>
          <input
        ...
        <div className="relative z-0 mb-6 w-full group">
          <label htmlFor="floating_location" className="text-xs">
            Location
          </label>
          <input
            onChange={handleUserInput}
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="floating_fn" className="text-xs">
              First name
            </label>
            <input
              onChange={handleUserInput}
          ...
          <div className="relative z-0 mb-6 w-full group">
            <label htmlFor="floating_ln" className="text-xs">
              Last name
            </label>
            <input
              onChange={handleUserInput}
